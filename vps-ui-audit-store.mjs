...
/* Keep both difference totals wide, with the three smaller metrics on one row. */
@media(max-width:560px){
  .store-data-screen .vps-audit-machine-grid{grid-template-columns:repeat(6,minmax(0,1fr))}

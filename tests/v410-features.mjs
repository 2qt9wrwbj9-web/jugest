...
if(!launcher.includes("const VERSION='4.8.6'")) throw new Error('launcher version mismatch');
if(!launcher.includes('const PARSER_VERSION=4500')) throw new Error('parser version must be 4500 for HANA reparse');
for(const x of ['NIGHT_MONTHS=13','NIGHT_WAIT_MIN_MS=25000','NIGHT_WAIT_MAX_MS=35000','15*60000,20*60000','30*60000,40*60000','45*60000,60*60000','id="jacNightStart"','id="jacRelaySend13"','id="jacExport13"']) if(!launcher.includes(x)) throw new Error('night feature missing: '+x);
...
console.log('v4.8.6 inherited features: ok');

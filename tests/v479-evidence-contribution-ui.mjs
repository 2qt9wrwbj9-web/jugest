...
for(const n of ['function v4RootContributionAuditHtml(r)','根拠寄与を分解','contributionES','contributionP4','実用順位の説明で、厳格P4+の確率計算とは別','weights=[1,.78,.62,.50,.40,.33,.27,.22,.18,.15]','if(!old||quality>old.quality)facts.set(g,{...x,factGroup:g,quality})','effectES:bruteClamp(effectES,-.85,.85)','p4Effect:bruteClamp(p4Effect,-.32,.32)'])if(!a.includes(n))throw Error('v479 guard: '+n);
console.log('v4.8.7 evidence contribution UI + independent-fact aggregation contract: ok');

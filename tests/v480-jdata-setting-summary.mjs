...
assert.ok(root.includes('appVersion:"4.8.6"'));
assert.ok(root.includes('>v4.8.6</span>'));
...
console.log('v4.8.6 jdata setting summary regression passed; v4.8.0 data-page semantics preserved');

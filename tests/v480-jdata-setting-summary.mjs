...
assert.ok(root.includes('appVersion:"4.8.4"'));
assert.ok(root.includes('>v4.8.4</span>'));
...
console.log('v4.8.4 jdata setting summary regression passed; v4.8.0 data-page semantics preserved');

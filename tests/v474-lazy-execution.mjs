...
assert.equal(crypto.createHash('sha256').update(launcher).digest('hex'),'bcc7db517014294b2cfd9339ef61c634d1402f87cd05a6d97b1f02261389b4d6','Launcher changed unexpectedly');

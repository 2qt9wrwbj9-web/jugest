...
const sets={relay:['secureMatch','readBody','cleanupExpiredPairCodes','getChannel','authReceiver','authSender','firstActiveMessage','messageMeta','createPair','claimPair','pairStatus','validatePayload','collectorPush','collectorPull','collectorStatus','sendMessage','peekInbox','receiveMessage','ackMessage','unlink'],sync:['secureMatch','readBody','validSyncId','validPayload','authenticate','createSync']};
...
console.log('Actual decoded functions: 20 Relay exact + 6 unchanged Sync core functions semantically preserved; getRecord/pushSync covered by concurrency regressions');

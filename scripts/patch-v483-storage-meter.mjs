...
for(const p of ['tests/netlify-deploy-preflight.mjs','tests/v480-jdata-setting-summary.mjs','tests/v481-evidence-alias-dedup.mjs','tests/v482-analysis-history.mjs']){let s=read(p).replaceAll('4\\.8\\.2','4\\.8\\.3').replaceAll('4.8.2','4.8.3');write(p,s)}

...
test('VPS release overlay labels PRE v2 shadow as JUGEST v6.0.1 without changing protected UI source',()=>{
  ...
  assert.match(patchTest.RELEASE_VERSION_MODULE_TAG,/vps-release-version\.mjs\?v=601-historical-summary-1/);

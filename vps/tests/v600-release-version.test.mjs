...
test('VPS release overlay labels PRE v2 shadow as JUGEST v6.0.2 without changing protected UI source',()=>{
  ...
  assert.match(patchTest.RELEASE_VERSION_MODULE_TAG,/vps-release-version\.mjs\?v=602-historical-audit-1/);
